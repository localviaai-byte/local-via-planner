...
function placeToFormData(place: Place): PlaceFormData {
  return {
    ...
    food_primary: (place as any).food_primary || [],
    food_secondary: (place as any).food_secondary || [],
    dietary_options: (place as any).dietary_options || [],
    format_experience: (place as any).format_experience || [],
    about_us: (place as any).about_us || '',
    contact_phone: (place as any).contact_phone || '',
    contact_email: (place as any).contact_email || '',
    contact_website: (place as any).contact_website || '',
